      ...
      const studentResults = teacher.studentsCreated
        .map((student) => {
          ...
          return {
            ...
            avgPerformance: round(average(performances)),
            avgErrorsCommitted: round(average(numberValues(student.results, "errorsCommitted"))),
            avgReactionTimeMs: round(average(numberValues(student.results, "reactionTimeMs"))),
            avgProgressPercent: round(average(numberValues(student.results, "progressPercent"))),
            avgSuccessRate: round(average(numberValues(student.results, "successRate"))),
            abandonedGames: student.results.filter((result) => result.abandoned).length,
