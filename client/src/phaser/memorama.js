...
function makeButton(scene, label, onClick, depth = 10, opts = {}) {
...
class MemoryScene extends Phaser.Scene {
  ...
  layoutEndModal() {
    ...
    placeBtn(this.endModal.btnAgain, W / 2 - 130 * ui, H / 2 + 70 * ui);
    placeBtn(this.endModal.btnExit, W / 2 + 130 * ui, H / 2 + 70 * ui);
  }
