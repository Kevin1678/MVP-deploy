...
import { COUNT_PICK_DIFFICULTIES } from "../constants";
...
export class CountPickMenuScene extends Phaser.Scene {
  ...
  create() {
    ...
    this.difficultyButtons = COUNT_PICK_DIFFICULTIES.map((option) =>
      makeTopLeftButton(
        this,
        option.label,
        () => {
          stopSpeech();
          this.scene.start("CountPickGameScene", { roundsTotal: option.roundsTotal });
        },
        10,
